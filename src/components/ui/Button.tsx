...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-[#03296A] hover:bg-[#244B75] text-white border-transparent shadow-sm',
  ...
  return (
    <button
      ...
      className={`
        ...
        border rounded-md transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#03296A]/40 focus:ring-offset-2
