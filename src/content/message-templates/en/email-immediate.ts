...
const emailImmediateEn: EmailTemplate = {
  subject: (vars: TemplateVars): string =>
    `Your HispanUSA appointment is confirmed — document checklist inside`,
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="font-size:15px;color:#374151;margin:0 0 24px;">
            Your appointment is confirmed! Below you'll find the document checklist you need to bring or send before your appointment.
          </p>
          <div style="background-color:#eff6ff;border-left:4px solid #1e40af;border-radius:4px;padding:16px 20px;margin-bottom:32px;">
            <p style="margin:0;font-size:14px;color:#1e40af;font-weight:bold;">APPOINTMENT DETAILS</p>
...
export default emailImmediateEn;
