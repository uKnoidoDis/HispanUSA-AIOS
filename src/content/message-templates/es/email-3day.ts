...
const email3DayEs: EmailTemplate = {
  subject: (vars: TemplateVars): string =>
    `Urgente: 3 días para su cita con HispanUSA`,
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="font-size:15px;color:#374151;margin:0 0 24px;">
            Su cita con HispanUSA es en <strong>3 días</strong> y aún no hemos recibido sus documentos.
            Si no los recibimos a tiempo, es posible que necesitemos reprogramar su cita.
          </p>
          <div style="background-color:#fff7ed;border-left:4px solid #ea580c;border-radius:4px;padding:16px 20px;margin-bottom:32px;">
            <p style="margin:0;font-size:14px;color:#ea580c;font-weight:bold;">🚨 ENVÍE SUS DOCUMENTOS HOY</p>
