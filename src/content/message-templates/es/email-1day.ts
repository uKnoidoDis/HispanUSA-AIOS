...
const email1DayEs: EmailTemplate = {
  subject: (vars: TemplateVars): string =>
    `Su cita es MAÑANA — verifique sus documentos`,
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="font-size:15px;color:#374151;margin:0 0 24px;">
            Su cita con HispanUSA es <strong>MAÑANA</strong>. Por favor verifique que tiene todos sus documentos listos.
            Si no puede traerlos, contáctenos hoy para reprogramar o enviarlos digitalmente.
          </p>
          <div style="background-color:#fef2f2;border-left:4px solid #dc2626;border-radius:4px;padding:16px 20px;margin-bottom:32px;">
            <p style="margin:0;font-size:14px;color:#dc2626;font-weight:bold;">📅 SU CITA ES MAÑANA</p>
          ...
          <div style="background-color:#f9fafb;border-radius:6px;padding:20px;margin-top:32px;text-align:center;">
            <p style="margin:0 0 8px;font-size:14px;color:#374151;font-weight:bold;">¿Preguntas? Contáctenos:</p>
            <p style="margin:0;font-size:15px;color:#1e40af;"><strong>taxes@hispanusa.com</strong></p>
            <p style="margin:8px 0 0;font-size:14px;color:#6b7280;"><strong>954-934-0194</strong></p>
          </div>
        </td></tr>
